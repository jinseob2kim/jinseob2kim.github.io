...
include_graphics("/home/secondmath/Dropbox/Hompage/mathemedicine.github.io/gwas/regional.png")
```


아래와 같이 결과 파일을 업로드한 후 P값, SNP의 컬럼을 지정하고 보여줄 화면(SNP, Gene, 특정 region)을 지정하면 된다. 
```{r, out.width= "100%",echo=F,fig.cap="Locuszoom 실행화면"}
include_graphics("/home/secondmath/Dropbox/Hompage/mathemedicine.github.io/gwas/locuszoom.png")
```
